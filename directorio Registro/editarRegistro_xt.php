...
if (isset($_POST["id"])){
    ...
    $sql = "update omar_directorio set nombre='$nombre', apellido='$apellido', empresa='$empresa', email='$email', telefono='$telefono', comentarios='$comentarios' where idDirectorio = ".$id;
